  ...
  return (
    <div className="relative flex flex-1 overflow-hidden bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="absolute top-3 right-3 flex items-center gap-0.5 rounded-full border border-neutral-200/80 bg-white/85 px-1 py-1 shadow-sm backdrop-blur-md dark:border-neutral-800/80 dark:bg-neutral-900/85">
        ...
        <span className="min-w-[3.5rem] text-center font-mono text-[11px] text-neutral-600 tabular-nums dark:text-neutral-400">
...
function MetadataPanel({
  ...
  return (
    <Collapsible
      ...
      className="border-border flex max-h-[40vh] shrink-0 flex-col border-t bg-white data-[state=closed]:max-h-none dark:bg-neutral-950"
    >
      ...
      <CollapsibleTrigger asChild>
        <button
          type="button"
          className="group border-border flex w-full items-center justify-between border-b px-4 py-2 text-left transition-colors hover:bg-neutral-50/60 dark:hover:bg-neutral-900/40"
        >
          <span className="text-xs text-neutral-400 dark:text-neutral-500">
            Generation details
          </span>
      ...
      <CollapsibleContent className="flex min-h-0 flex-col overflow-hidden">
        ...
        <div className="border-border grid grid-cols-2 gap-1.5 border-t px-4 py-3 sm:grid-cols-3 lg:grid-cols-[auto_auto_auto_1fr]">
